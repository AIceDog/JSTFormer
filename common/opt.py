...
class opts():
    ...
    def init(self):
        self.parser.add_argument('--manualSeed', default=42, type=int)
        self.parser.add_argument('--layers', default=2, type=int)    
        self.parser.add_argument('--channel', default=24, type=int)
        self.parser.add_argument('--dataset', type=str, default='h36m')
        self.parser.add_argument('-k', '--keypoints', default='cpn_ft_h36m_dbb', type=str) # cpn: cpn_ft_h36m_dbb, gt
        ...
        self.parser.add_argument('--gpu', default='0, 1', type=str, help='') # 0, 1, 2, 3, 4
        self.parser.add_argument('--train', default=1)
        self.parser.add_argument('--resume', type=str, default='') # resume, eg : 0330_0113_49_243
        self.parser.add_argument('--test', action='store_true')
        self.parser.add_argument('--nepoch', type=int, default=250)
        self.parser.add_argument('--batch_size', type=int, default=4000, help='can be changed depending on your machine')
        ...
        self.parser.add_argument('--frames', type=int, default=81)
        self.parser.add_argument('--pad', type=int, default=40) 
    ...
    def parse(self):
        ...
        if self.opt.train and self.opt.resume:
            self.opt.checkpoint = 'checkpoint/' + self.opt.resume  # self.opt.checkpoint : checkpoint/0328_0252_48_243
            
        elif self.opt.train and self.opt.resume == '':
